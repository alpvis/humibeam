...
// Mac-/humitext-spezifische LLM-Funktionen. Der plattformneutrale Kern
// (LLMError, RewriteModel, LLMService.ask/complete) liegt in LLMCore.swift (geteilt mit iOS).
