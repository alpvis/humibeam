...
enum HumibeamInstallLocationService {
    ...
    enum MoveError: LocalizedError {
        ...
        var errorDescription: String? {
            ...
            case .destinationExists:
                return "Am Zielort liegt bereits eine Humibeam-Installation."
            case .destinationNotWritable:
                return "Der Zielordner /Applications ist auf diesem Mac nicht beschreibbar."
            case .copyFailed:
                return "Humibeam konnte nicht nach /Applications kopiert werden."
            }
        }
    }
